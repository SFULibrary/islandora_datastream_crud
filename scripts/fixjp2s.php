...
/**
 * Some (but not all) JP2 files generated by CONTENTdm do not
 * work in Islandora. They show up as entirely black images.
 * The CONTENTdm files are valid JP2s, but they just don't work
 * when viewed in Islandora.
 *
 * This script uses ImageMagick's convert command to convert
 ...
 *
 * Usage: php fixjp2s.php /path/to/jp2/files/directory [remove_backups]
 *
...
if (!`which convert`) {
    print "Can't find \"convert\" executable, exiting." . PHP_EOL;
    exit;
}
