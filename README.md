...
Note that you can include Drush's `-y` option to bypass confirmation promps. This is useful if you are running Datastream CRUD in a `nohup` or scripted environment.
